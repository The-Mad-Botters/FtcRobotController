...
Break a longer, winding route into understandable pieces. Use descriptive methods so a teammate can follow your plan.

**What you are learning:** readable routes made from small methods.
...
1. Mark a few checkpoints on your sketch.
2. Test the first curve before adding later sections.
3. Create a named method for a repeated motion and build your route a checkpoint at a time.
...
1. In the open **FtcRobotController** project on branch **SimulatorLessons**, find `TeamCode/src/main/java/org/firstinspires/ftc/teamcode/SimulatorLessons/FtcMovement/Lesson8`.
2. Create a Java class named **`MovementLesson8Starter`**. Replace the entire file with the code below, including its package line. Keep the coach's files intact.
...
4. To run in **FTC Sim OnBot Java**, copy your code, remove the `package ...;` line from the simulator copy, and change `public class MovementLesson8Starter` to `public class MyFIRSTJavaOpMode`. Keep `extends LinearOpMode`, imports, and helper methods. Leave the Android Studio name unchanged.
...
public class MovementLesson8Starter extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // TODO: Mark a few checkpoints on your sketch.
...
- your answer to: **If an early turn is wrong, how can that affect a later collision?**

You do not have to finish the whole maze to show useful progress. Be honest about unfinished work and help you used.

**Stretch:** Build named movement methods that call one shared helper; explain both levels.

## Coach's solutions: references you may use

- [MyFIRSTJavaOpMode_8_Solution.java](MyFIRSTJavaOpMode_8_Solution.java)
- [MyFIRSTJavaOpMode_8_Solution_Methods.java](MyFIRSTJavaOpMode_8_Solution_Methods.java)
- [MyFIRSTJavaOpMode_8_WithEncoder.java](MyFIRSTJavaOpMode_8_WithEncoder.java)
