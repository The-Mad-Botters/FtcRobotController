...
public class MyFIRSTJavaOpMode_5L_WithEncoder extends LinearOpMode {
    DcMotor motorLeft;
    DcMotor motorRight;
    DcMotor frontLeft;
    DcMotor frontRight;
    ...
    public void runOpMode() {
        ...
        // Turn towards flag
        rotate(90);
        // move backwards to get the duck
        moveLinear(-2.0);
        // now move to flag
        moveLinear(3.5);
     ...
     */
    private void encoderDrive(double speed, double leftTicks, double rightTicks) {
        int newLeftTarget;
        int newRightTarget;
        ...
        if (opModeIsActive()) {
            ...
            newLeftTarget = motorLeft.getCurrentPosition() + (int)(leftTicks);
            newRightTarget = motorRight.getCurrentPosition() + (int)(rightTicks);
            ...
            motorLeft.setPower(speed); //Math.abs(speed));
            motorRight.setPower(speed); //Math.abs(speed));
