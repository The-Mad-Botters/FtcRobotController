# Movement 10: Open Ended

[All simulator lessons](../../README.md) · [Movement course](../readme.md)

## Your mission

Choose a goal on the field and design a route you can explain. Compare alternatives using evidence from your runs.

**What you are learning:** choose, test, and justify a route.
...
1. Name your chosen goal and sketch two possible routes.
2. Choose one route and build it in short, tested sections.
3. Reset and repeat your test. Compare a second route or improve one weak section.
...
1. In the open **FtcRobotController** project on branch **SimulatorLessons**, find `TeamCode/src/main/java/org/firstinspires/ftc/teamcode/SimulatorLessons/FtcMovement/Lesson10`.
2. Create a Java class named **`MovementLesson10Starter`**. Replace the entire file with the code below, including its package line. Keep the coach's files intact.
...
4. To run in **FTC Sim OnBot Java**, copy your code, remove the `package ...;` line from the simulator copy, and change `public class MovementLesson10Starter` to `public class MyFIRSTJavaOpMode`. Keep `extends LinearOpMode`, imports, and helper methods. Leave the Android Studio name unchanged.
...
public class MovementLesson10Starter extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // TODO: Name your chosen goal and sketch two possible routes.
...
- your answer to: **Why did you choose this route, and what evidence would make you change it?**

You do not have to finish the whole maze to show useful progress. Be honest about unfinished work and help you used.

**Stretch:** Compare two routes for repeatability and readability, not just speed.

## Coach's solutions: references you may use

- [MyFIRSTJavaOpMode_10_Solution.java](MyFIRSTJavaOpMode_10_Solution.java)
- [MyFIRSTJavaOpMode_10_Solution_Methoda.java](MyFIRSTJavaOpMode_10_Solution_Methoda.java)
